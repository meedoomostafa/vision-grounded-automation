    ...
    def _choose_candidate(candidates):
        ...
        for candidate in candidates:
            ...
            if (
                ...
                # Avoid matching editor/terminal host windows whose title merely contains stale "Notepad" text.
                continue

            # Suppress helper/overlay windows that frequently appear in ambiguous sets.
